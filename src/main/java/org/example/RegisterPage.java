...
public class RegisterPage extends Utils{
    ...
    public void enterRegistrationDetails() {
        //expected result
        String Expected_Registration_Url = "https://demo.nopcommerce.com/register?returnUrl=%2F";
        //actual result
        String Actual_Registration_Url = driver.getCurrentUrl();
        //verify expected and actual result
        Assert.assertEquals(Actual_Registration_Url,Expected_Registration_Url,"Register page is not displayed");
        System.out.println("Register page assert =" + " "+loadProperty.getProperty("RegistrationPageMessage"));

        waitForClickable(_registerButton,30);
